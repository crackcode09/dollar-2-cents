...
- Dollar → Coins: greedy change breakdown (quarters, dimes, nickels, pennies)
- Coins → $: count coins on hand, see total value
- Animated counters, coin flip + pip visualizations, coin rain
